    ...
    <div id="portfolioFlex">
      <div className="horizontalFlex spacebtwn btmSpacer">
        <div className="sectionText left">
          ...
          <div className="eighty">
            <h3>Purpose:</h3>
            <p className="smaller">As a language learning platform, BeepBoop
          ...
          <div className="eighty">
            <h3>Team:</h3>
            <p className="smaller">Salvatore Lupo - Designer <br />
          ...
          <div className="eighty">
            ...
            <div className="horizontalFlex verticalAlign additionalInfo">
              <div className="beepBoopTag smaller">Mobile</div>
              <div className="beepBoopTag smaller">Light UI</div>
              <div className="beepBoopTag smaller">Spanish</div>
              <div className="beepBoopTag smaller">Startup</div>
              <div className="beepBoopTag smaller">Education</div>
            </div>
          </div>
        </div>
      ...
      <div className="horizontalFlex spacebtwn btmSpacer">
        <div className="left-spacer">
          ...
          <p className="smaller">BeepBoop’s user interface relied on the Calendly
        ...
        <div className="right-spacer">
          ...
          <p className="smaller">Established in 2019, BeepBoop aims to help users
      ...
      <div className="horizontalFlex btmSpacer">
        ...
        <div className="right-spacer">
          ...
          <p className=" smaller">The each member of the design team sketched eight screens in eight minutes, depicting the main features:</p>
          <li>Profile page </li>
          <li>Live Drills - Video Streaming Page  </li>
          <li>Drill Course Catalog </li>
          <li>Course Dashboard </li>
          <p className=" smaller">As a team we used the dot voting method to identify the screens that we wanted to prototype keeping in mind the points for virality for the proudct </p>
        </div>
      </div>
      ...
      <div className="horizontalFlex verticalAlign btmSpacer">
        <div className="left-spacer">
          <h3 className="orangeText">Ideation - Crazy 8s</h3>
          <p className=" smaller">In an attempt to deviate from industry standard navigation bar, the team decided to play with rounded corners and centered on the live streaming aspect.
      ...
      <div className="horizontalFlex verticalAlign btmSpacer">
        <div className="left-spacer">
          <h3 className="orangeText">Ideation - Crazy 8s</h3>
          <p className=" smaller">Quick user testing on the greyscales confirmed the direction in whcih the team moved forward for the high fidelity screens. As a team we divided
          ...
          <p className=" smaller">User testing showed that the core funcitoinality of the app served its purposel; however gave multiple insights into new directions and features
      ...
      <div className="horizontalFlex btmSpacer">
        <div className="left-spacer">
          ...
          <p className=" smaller">Being in such early stages of the start up, there was so much flexibility to take the company
      ...
      <div className="horizontalFlex">
        ...
        <div className="right">
          ...
          <p className="smaller">Iterating on design is a necessary part of the process.
